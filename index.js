...
const environment = new Object(),loader = new THREE.TextureLoader(),water_tex = loader.load('https://krew.io/assets/img/water.jpg');
        ...
        elem.change(()=>{
            ...
            if (inp.files && inp.files[0]) {
                ...
                reader.onload = function (e) {
                    ...
                    let newMat = new THREE.MeshPhongMaterial({map:newTex})
                    console.log(newMat)
